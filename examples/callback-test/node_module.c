...
// // STATIC const mp_rom_map_elem_t node_module_globals_table[] = {
// //     { MP_ROM_QSTR(MP_QSTR___name__), MP_ROM_QSTR(MP_QSTR_node) },
// // };
// // STATIC MP_DEFINE_CONST_DICT(node_module_globals, node_module_globals_table);


// // // Define module object.
// // const mp_obj_module_t node_user_cmodule = {
// //     .base = { &mp_type_module },
// //     .globals = (mp_obj_dict_t*)&node_module_globals,
// // };

// // // Register the module to make it available in Python.
// // MP_REGISTER_MODULE(MP_QSTR_node, node_user_cmodule); 